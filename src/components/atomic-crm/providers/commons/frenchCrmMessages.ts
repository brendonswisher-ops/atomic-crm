...
export const frenchCrmMessages = {
  resources: {
    ...
    contacts: {
      ...
      to_contact: {
        ...
        empty_hint:
          "Les contacts Nouveau ou Contacté qui vous sont assignés apparaissent ici.",
      },
      views: {
        all: "Tous",
        new: "Nouveau",
  ...
  crm: {
    ...
    dashboard: {
      ...
      zurich: "Zürich",
      raise_title: "Levée STMS",
      pipeline_snapshot: "Pipeline",
      pipeline_stms_of_total: "%{stms} STMS sur %{total}",
      pipeline_all_deals: "Toutes les affaires",
      stale_intros: "Intros inactives",
